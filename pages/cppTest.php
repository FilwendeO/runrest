...
<html>
	<head>
		<meta charset="utf-8"/>
		<title>runTest/Essai Quizz C++</title>
		<link rel="stylesheet" href="../style/acceuil.css"/>
		<link rel="stylesheet" href="../style/suite.css"/>
	...
	<body> 
		<div class="container">
			...
			<form class="form form-control" action="traitementTestQuizzCpp.php" method="post">
							<fieldset>
								...
								<label>Question 7:Le C Est Plus Ancien Que Le C++?</label><br/>
