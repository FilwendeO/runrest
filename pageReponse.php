<?php session_start();include("fonctionPhp.php");$lang=strip_tags($_GET['lan']);$niveau=strip_tags($_GET['niveau']);if(empty($_SESSION['usId'])) header("Location:utilisateur.php");
...
<html>
	<head>
		<meta charset="utf-8"/>
		<title>runrest/Reponses Précédantes</title>
